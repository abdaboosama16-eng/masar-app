    ...
    return (
      <div className="space-y-8 animate-pulse" dir="rtl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          <div className="lg:col-span-2 h-72 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl p-6">
  ...
  return (
    <div className="space-y-8 transition-colors duration-500 ease-in-out" dir="rtl">
      ...
      <div className="opacity-0 animate-fade-in-up">
        <h1 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white tracking-tight leading-relaxed">
          لوحة التحكم
        </h1>
        <p className="text-xs md:text-sm text-slate-500 dark:text-gray-400 mt-1 font-medium leading-relaxed">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="opacity-0 animate-fade-in-up stagger-1 delay-100 bg-white dark:bg-slate-900 rounded-xl shadow-sm border-2 border-sky-200 dark:border-sky-800/60 p-6 hover:shadow transition-all duration-300 flex flex-col justify-between">
          ...
          <div>
            <div className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight font-mono leading-relaxed">
        ...
        <div className="opacity-0 animate-fade-in-up stagger-2 delay-100 bg-white dark:bg-slate-900 rounded-xl shadow-sm border-2 border-indigo-200 dark:border-indigo-800/60 p-6 hover:shadow transition-all duration-300 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
        ...
        <div className="opacity-0 animate-fade-in-up stagger-3 delay-100 bg-white dark:bg-slate-900 rounded-xl shadow-sm border-2 border-emerald-200 dark:border-emerald-800/60 text-emerald-600 p-6 hover:shadow transition-all duration-300 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
        ...
        <div className="opacity-0 animate-fade-in-up stagger-4 delay-100 bg-white dark:bg-slate-900 rounded-xl shadow-sm border-2 border-red-200 dark:border-red-800/60 text-red-600 p-6 hover:shadow transition-all duration-300 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
      ...
      <div className="opacity-0 animate-fade-in-up stagger-5 delay-100 bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-xl p-6 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 border-b border-gray-100 dark:border-slate-800 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-extrabold text-base text-slate-900 dark:text-white leading-relaxed">توزيع الطلاب حسب المراحل الدراسية</h3>
          ...
          <div className="self-start sm:self-auto bg-gray-50 dark:bg-slate-800 text-gray-700 dark:text-gray-300 px-3.5 py-1.5 rounded-xl text-xs font-bold border border-gray-200 dark:border-slate-700 flex items-center gap-2">
            ...
            <span className="leading-relaxed">إجمالي المقيدين: <strong className="text-sm font-black text-slate-900 dark:text-white">{classStats.totalStudents}</strong></span>
          </div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {/* Class 1: Early Education (التعليم المبكر) */}
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border-2 border-green-200 dark:border-green-800/60 p-6 flex flex-col justify-between hover:border-green-300 transition-all">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-green-500"></span>
                <span className="text-xs font-bold text-slate-900 dark:text-white leading-relaxed">التعليم المبكر</span>
              </div>
            ...
            <div className="flex items-baseline justify-between mt-2">
              <span className="text-2xl font-black text-slate-900 dark:text-white font-mono leading-relaxed">{classStats.earlyEduCount}</span>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border-2 border-purple-200 dark:border-purple-800/60 p-6 flex flex-col justify-between hover:border-purple-300 transition-all">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-purple-500"></span>
                <span className="text-xs font-bold text-slate-900 dark:text-white leading-relaxed">الروضة</span>
              </div>
            ...
            <div className="flex items-baseline justify-between mt-2">
              <span className="text-2xl font-black text-slate-900 dark:text-white font-mono leading-relaxed">{classStats.kindergartenCount}</span>
              <span className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">طالب/ـة</span>
            </div>
          </div>

          {/* Class 3: Preparatory (التأهيلي) */}
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border-2 border-yellow-200 dark:border-yellow-800/60 p-6 flex flex-col justify-between hover:border-yellow-300 transition-all">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-yellow-400"></span>
                <span className="text-xs font-bold text-slate-900 dark:text-white leading-relaxed">التأهيلي</span>
              </div>
            ...
            <div className="flex items-baseline justify-between mt-2">
              <span className="text-2xl font-black text-slate-900 dark:text-white font-mono leading-relaxed">{classStats.preparatoryCount}</span>
              <span className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">طالب/ـة</span>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Treasury Chart Card */}
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-xl p-6 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-extrabold text-slate-900 dark:text-white text-sm">{t('treasury_movement')}</h3>
        ...
        <div className="space-y-4 flex flex-col justify-between">
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-xl p-5 shadow-sm flex items-center justify-between hover:shadow transition-all">
            <div>
              <p className="text-xs font-bold text-gray-500 dark:text-gray-400 mb-1">{t('registered_students')}</p>
              <p className="text-3xl font-black text-slate-900 dark:text-white font-mono">{classStats.totalStudents}</p>
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-xl p-5 shadow-sm flex items-center justify-between hover:shadow transition-all">
            <div>
              ...
              <p className="text-3xl font-black text-slate-900 dark:text-white font-mono">{stats.teachersCount}</p>
      ...
      <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm">
        <div className="px-6 py-4 border-b border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-800/40 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-blue-50 dark:bg-slate-800 text-blue-600 dark:text-blue-400 rounded-lg">
              <FileSpreadsheet size={16} />
            </div>
            <h3 className="font-extrabold text-slate-900 dark:text-white text-sm">{t('recent_transactions')}</h3>
          </div>
